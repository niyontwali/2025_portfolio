...
const Index = () => {
  ...
  return (
    <Fragment>
      <Head>
        <title>John Niyontwali - Senior Full-Stack Developer | React, Node.js, Python</title>
        <meta name="description" content="Senior Full-Stack Developer with 8+ years experience in React.js, Next.js, Node.js, Python, FastAPI, and AWS. Based in Kigali, Rwanda. Mentored 100+ developers, built applications for 10,000+ users." />
        <meta name="keywords" content="John Niyontwali, Senior Full-Stack Developer, React.js, Next.js, Node.js, Python, FastAPI, JavaScript, TypeScript, AWS, GCP, Software Engineer, Kigali Rwanda, Technical Mentor, Andela, WelTel, Springboard" />
        ...
        <meta name="twitter:title" content="John Niyontwali - Senior Full-Stack Developer" />
        <meta name="twitter:description" content="8+ years building scalable web applications with React, Node.js, Python. Technical mentor and team lead." />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "knowsAbout": [
                "React.js", "Next.js", "Node.js", "Python", "FastAPI", "JavaScript", "TypeScript",
                "AWS", "Google Cloud Platform", "MongoDB", "PostgreSQL", "Docker", "Kubernetes"
              ]
            })
          }}
        />
